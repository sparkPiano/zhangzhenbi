 ...
 * @Version: 1.0
 * @Autor: Edison Lu
 * @Date: 2020-11-19 09:11:23
 * @LastEditors: Edison Lu
 * @LastEditTime: 2020-12-10 15:14:59
-->
...
<template>
  <div>
    ...
    <ccb-product
      :formEleProp="formEleProp.product"
...
export default {
  ...
  methods: {
    ...
    ...mapActions(["getProductListAsync", "getCacheProductListAsync"]),
    ...mapMutations([
      "updateCartNumber",
      "updateRetPage",
